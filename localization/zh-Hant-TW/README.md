...
- 保留工具名稱、連結、分類與原文限制
- 讓小型社群能先按治理需求找到可研究的工具
- 明確區分開放原始碼工具、開放權重模型、資料集與非開源服務
- 不把收錄解讀為 ROOST、翻譯者或維護者的推薦
- 追蹤英文來源 commit，來源有變動時要求重新核對
...
- [`scripts/check.sh`](scripts/check.sh) 檢查來源差異、工具筆數與未完成標記

## 目前狀態

14 個分類、113 項工具已完成第一輪翻譯，狀態為 `translated`。目前仍需另一位台灣繁體中文審查者，以及具有信任與安全或平台治理經驗的領域審查者確認，才會標示為 `reviewed`。

## 重要限制

原始清單明確表示，收錄不代表推薦。工具的維護狀態、授權、安全性、隱私影響、語言涵蓋率與使用條件都可能變動，採用前仍應回到各工具的官方來源重新確認。
